...
function calculateAngles(keypointLocations) {
  ...
  let angleDhruv = getAngle("right", "Shoulder", "Hip", "Knee", keypointLocations)
  return angleDhruv;
}

function getAngle(side, part1, part2, part3, keypointLocations) {
  let x1 = keypointLocations[side + part1].x
  let x2 = keypointLocations[side + part2].x
  let x3 = keypointLocations[side + part3].x

  let y1 = -keypointLocations[side + part1].y
  let y2 = -keypointLocations[side + part2].y
  let y3 = -keypointLocations[side + part3].y
