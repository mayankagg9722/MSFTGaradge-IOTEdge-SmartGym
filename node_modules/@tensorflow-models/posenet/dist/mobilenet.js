...
function assertValidScaleFactor(imageScaleFactor) {
    tf.util.assert(typeof imageScaleFactor === 'number', function () { return 'imageScaleFactor is not a number'; });
    tf.util.assert(imageScaleFactor >= 0.2 && imageScaleFactor <= 1.0, function () { return 'imageScaleFactor must be between 0.2 and 1.0'; });
}
