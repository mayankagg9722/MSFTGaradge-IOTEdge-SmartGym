                    ...
                    case 1:
                        ...
                        _loop_1 = function (key) {
                            ...
                            if (typeof value === 'number') {
                                ...
                                this_1.totals[key] = tfjs_core_1.tidy(function () { return tfjs_core_1.add(_this.totals[key], tfjs_core_1.mul(value, batchSize)); });
                            ...
                            _loop_2 = function (key) {
                                ...
                                if (typeof this_2.totals[key] === 'number') {
                                    ...
                                    tfjs_core_1.tidy(function () {
                                        logs[key] = tfjs_core_1.mul(tfjs_core_1.div(1, _this.seen), _this.totals[key]);
