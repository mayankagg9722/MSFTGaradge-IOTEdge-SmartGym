...
export declare function setBackend(backendName: string): boolean;
/**
 ...
 */
export declare function findBackendFactory(name: string): () => KernelBackend;
/**
 ...
 */
/** @doc {heading: 'Backends'} */
export declare function registerBackend(name: string, factory: () => KernelBackend, priority?: number): boolean;
/**
