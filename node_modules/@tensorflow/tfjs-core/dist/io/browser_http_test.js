...
jasmine_util_1.describeWithFlags('browserHTTPRequest-load fetch', jasmine_util_1.NODE_ENVS, function () {
    var requestInits;
    // tslint:disable-next-line:no-any
    var originalFetch;
...
jasmine_util_1.describeWithFlags('browserHTTPRequest-save', jasmine_util_1.CHROME_ENVS, function () {
    // Test data.
    var weightSpecs1 = [
        {
            name: 'dense/kernel',
...
jasmine_util_1.describeWithFlags('browserHTTPRequest-load', jasmine_util_1.BROWSER_ENVS, function () {
