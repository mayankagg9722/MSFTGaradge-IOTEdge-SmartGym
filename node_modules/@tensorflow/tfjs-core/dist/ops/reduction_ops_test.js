...
jasmine_util_1.describeWithFlags('Reduction: min', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var x = tf.scalar(42);
        var dy = tf.scalar(-1);
        var gradients = tf.grad(function (v) { return tf.min(v.clone()).clone(); })(x, dy);
        test_util_1.expectArraysClose(gradients, tf.scalar(-1));
    });
...
jasmine_util_1.describeWithFlags('Reduction: max', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var x = tf.scalar(42);
        var dy = tf.scalar(-1);
        var gradients = tf.grad(function (v) { return tf.max(v.clone()).clone(); })(x, dy);
        test_util_1.expectArraysClose(gradients, tf.scalar(-1));
    });
...
jasmine_util_1.describeWithFlags('Reduction: argmax', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.tensor2d([3, 2, 5, 100, -7, 2], [2, 3]);
        var dy = tf.ones([3], 'float32');
        var da = tf.grad(function (x) { return tf.argMax(x.clone()).clone(); })(a, dy);
        expect(da.dtype).toBe('float32');
        expect(da.shape).toEqual([2, 3]);
        test_util_1.expectArraysClose(da, [0, 0, 0, 0, 0, 0]);
    });
...
jasmine_util_1.describeWithFlags('Reduction: argmin', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.tensor2d([3, 2, 5, 100, -7, 2], [2, 3]);
        var dy = tf.ones([3], 'float32');
        var da = tf.grad(function (x) { return tf.argMin(x.clone()).clone(); })(a, dy);
        expect(da.dtype).toBe('float32');
        expect(da.shape).toEqual([2, 3]);
        test_util_1.expectArraysClose(da, [0, 0, 0, 0, 0, 0]);
    });
...
jasmine_util_1.describeWithFlags('Reduction: sum', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
        var dy = tf.scalar(10);
        var gradients = tf.grad(function (a) { return a.clone().sum().clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [10, 10, 10, 10, 10, 10]);
    });
...
jasmine_util_1.describeWithFlags('Reduction: mean', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.tensor2d([1, 2, 3, 0, 0, 1], [3, 2]);
        var dy = tf.scalar(1.5);
        var da = tf.grad(function (a) { return a.clone().mean().clone(); })(a, dy);
        var dyVal = dy.arraySync();
        expect(da.shape).toEqual(a.shape);
        test_util_1.expectArraysClose(da, [
            dyVal / a.size, dyVal / a.size, dyVal / a.size, dyVal / a.size,
