...
jasmine_util_1.describeWithFlags('prelu', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var x = tf.tensor1d([0.5, 3, -0.1, -4]);
        var a = tf.tensor1d([0.2, 0.4, 0.25, 0.15]);
        var dx = tf.grad(function (x) { return tf.prelu(x.clone(), a).clone(); })(x);
        expect(dx.shape).toEqual(x.shape);
        expect(dx.dtype).toEqual('float32');
        test_util_1.expectArraysClose(dx, [1, 1, 0.25, 0.15]);
    });
...
jasmine_util_1.describeWithFlags('maximum', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var b = tf.scalar(0.6);
        var dy = tf.scalar(3);
        var grads = tf.grads(function (a, b) { return tf.maximum(a.clone(), b.clone()).clone(); });
        var _a = grads([a, b], dy), da = _a[0], db = _a[1];
        expect(da.shape).toEqual(a.shape);
        expect(db.shape).toEqual(b.shape);
        expect(da.dtype).toEqual('float32');
...
jasmine_util_1.describeWithFlags('squaredDifference', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var b = tf.scalar(0.6);
        var dy = tf.scalar(3);
        var grads = tf.grads(function (a, b) { return tf.squaredDifference(a.clone(), b.clone()).clone(); });
        var _a = grads([a, b], dy), da = _a[0], db = _a[1];
        expect(da.shape).toEqual(a.shape);
        expect(db.shape).toEqual(b.shape);
        expect(da.dtype).toEqual('float32');
...
jasmine_util_1.describeWithFlags('minimum', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var b = tf.scalar(0.6);
        var dy = tf.scalar(3);
        var grads = tf.grads(function (a, b) { return tf.minimum(a.clone(), b.clone()).clone(); });
        var _a = grads([a, b], dy), da = _a[0], db = _a[1];
        expect(da.shape).toEqual(a.shape);
        expect(db.shape).toEqual(b.shape);
        expect(da.dtype).toEqual('float32');
...
jasmine_util_1.describeWithFlags('mod', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var b = tf.scalar(0.6);
        var dy = tf.scalar(3);
        var grads = tf.grads(function (a, b) { return tf.mod(a.clone(), b.clone()).clone(); });
        var _a = grads([a, b], dy), da = _a[0], db = _a[1];
        expect(da.shape).toEqual(a.shape);
        expect(db.shape).toEqual(b.shape);
        expect(da.dtype).toEqual('float32');
...
jasmine_util_1.describeWithFlags('atan2', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var b = tf.scalar(2);
        var dy = tf.scalar(4);
        var grads = tf.grads(function (a, b) { return tf.atan2(a.clone(), b.clone()).clone(); });
        var _a = grads([a, b], dy), da = _a[0], db = _a[1];
        expect(da.shape).toEqual(a.shape);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, [4 * 2 / 29]);
