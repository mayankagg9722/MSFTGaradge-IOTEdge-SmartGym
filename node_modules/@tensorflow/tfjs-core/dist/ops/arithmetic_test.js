...
jasmine_util_1.describeWithFlags('div', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var grads = tf.grads(function (a, b) { return tf.div(a.clone(), b.clone()).clone(); });
        var _a = grads([5, 2]), da = _a[0], db = _a[1];
        expect(da.shape).toEqual([]);
        expect(db.shape).toEqual([]);
        test_util_1.expectArraysClose(da, [1 / 2]);
        test_util_1.expectArraysClose(db, [-5 / 4]);
    });
...
jasmine_util_1.describeWithFlags('mul', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var grads = tf.grads(function (a, b) { return tf.mul(a.clone(), b.clone()).clone(); });
        var _a = grads([4, 2]), da = _a[0], db = _a[1];
        expect(da.shape).toEqual([]);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, 2);
        expect(db.shape).toEqual([]);
        expect(db.dtype).toEqual('float32');
        test_util_1.expectArraysClose(db, 4);
    });
    it('gradient: Tensor1D', function () {
        var a = tf.tensor1d([1, 2, 3]);
        var b = tf.tensor1d([3, 4, 5]);
...
jasmine_util_1.describeWithFlags('pow', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(5);
        var b = tf.scalar(2, 'int32');
        var grads = tf.grads(function (a, b) { return tf.pow(a.clone(), b.clone()).clone(); });
        var _a = grads([a, b]), da = _a[0], db = _a[1];
        expect(da.shape).toEqual(a.shape);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, [2 * 5]);
        expect(db.shape).toEqual(b.shape);
        expect(db.dtype).toEqual('float32');
        test_util_1.expectArraysClose(db, [Math.pow(5, 2) * Math.log(5)]);
    });
...
jasmine_util_1.describeWithFlags('add', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var b = tf.tensor1d([3, 4, 5]);
        var dy = tf.tensor1d([7, 8, 9]);
        var grads = tf.grads(function (a, b) { return tf.add(a.clone(), b.clone()).clone(); });
        var _a = grads([a, b], dy), da = _a[0], db = _a[1];
        expect(da.shape).toEqual(a.shape);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, [7 + 8 + 9]);
...
jasmine_util_1.describeWithFlags('sub', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var b = tf.tensor1d([3, 2, 1]);
        var dy = tf.tensor1d([1, 10, 20]);
        var grads = tf.grads(function (a, b) { return tf.sub(a.clone(), b.clone()).clone(); });
        var _a = grads([a, b], dy), da = _a[0], db = _a[1];
        expect(da.shape).toEqual(a.shape);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, [1, 10, 20]);
