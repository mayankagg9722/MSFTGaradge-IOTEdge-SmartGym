...
jasmine_util_1.describeWithFlags('relu', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(3);
        var dy = tf.scalar(5);
        var grad = tf.grad(function (a) { return tf.relu(a.clone()).clone(); });
        var da = grad(a, dy);
        expect(da.shape).toEqual(a.shape);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, [5]);
...
jasmine_util_1.describeWithFlags('abs', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('is underflow-safe for complex64', function () {
        var floatBits = tf.backend().floatPrecision();
        var small;
        switch (floatBits) {
            case 32:
                small = 1e-30;
...
jasmine_util_1.describeWithFlags('step', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(-4);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.step(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0]);
    });
...
jasmine_util_1.describeWithFlags('neg', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradients: Scalar', function () {
        var a = tf.scalar(4);
        var dy = tf.scalar(8);
        var da = tf.grad(function (a) { return tf.neg(a.clone()).clone(); })(a, dy);
        expect(da.shape).toEqual(a.shape);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, [8 * -1]);
    });
...
jasmine_util_1.describeWithFlags('sigmoid', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.tensor1d([1, 2, -3, 5]);
        var dy = tf.tensor1d([1, 2, 3, 4]);
        var da = tf.grad(function (a) { return tf.sigmoid(a.clone()).clone(); })(a, dy);
        var aVals = a.arraySync();
        var dyVals = dy.arraySync();
        var expected = [];
        for (var i = 0; i < a.size; i++) {
...
jasmine_util_1.describeWithFlags('logSigmoid', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var dy = tf.tensor1d([1, 2, 3, 4]);
        var dyVals = dy.arraySync();
        var da = tf.grad(function (a) { return tf.logSigmoid(a.clone()).clone(); })(a, dy);
        var expected = [];
        for (var i = 0; i < a.size; i++) {
            var y = 1 / (1 + Math.exp(aVals[i]));
            expected[i] = dyVals[i] * y;
...
jasmine_util_1.describeWithFlags('softplus', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradients: Scalar', function () {
        ...
        var aVal = a.arraySync();
        var dyVal = dy.arraySync();
        var da = tf.grad(function (a) { return tf.softplus(a.clone()).clone(); })(a, dy);
        var y = 1 / (1 + Math.exp(-aVal));
        test_util_1.expectArraysClose(da, [dyVal * y]);
    });
    it('gradients: Tensor1D', function () {
...
jasmine_util_1.describeWithFlags('sqrt', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(4);
        var dy = tf.scalar(8);
        var da = tf.grad(function (a) { return tf.sqrt(a.clone()).clone(); })(a, dy);
        expect(da.shape).toEqual(a.shape);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, [8 / (2 * Math.sqrt(4))]);
    });
...
jasmine_util_1.describeWithFlags('rsqrt', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradients: Scalar', function () {
        var a = tf.scalar(4);
        var dy = tf.scalar(8);
        var da = tf.grad(function (a) { return tf.rsqrt(a.clone()).clone(); })(a, dy);
        expect(da.shape).toEqual(a.shape);
        expect(da.dtype).toEqual('float32');
        test_util_1.expectArraysClose(da, [(-1 * 8) / (2 * Math.pow(4, 1.5))]);
    });
...
jasmine_util_1.describeWithFlags('square', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradients: Scalar', function () {
        var a = tf.scalar(5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.square(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [2 * 5 * 8]);
    });
...
jasmine_util_1.describeWithFlags('reciprocal', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.reciprocal(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [-1 * 8 * (1 / (5 * 5))]);
    });
...
jasmine_util_1.describeWithFlags('log', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(5);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.log(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [3 / 5]);
    });
...
jasmine_util_1.describeWithFlags('ceil', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(5.2);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.ceil(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0]);
    });
...
jasmine_util_1.describeWithFlags('floor', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(5.2);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.floor(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0]);
    });
...
jasmine_util_1.describeWithFlags('sign', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(5.2);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.sign(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0]);
    });
...
jasmine_util_1.describeWithFlags('isNaN', jasmine_util_1.ALL_ENVS, function () {
    it('basic', function () {
        var a = tf.tensor1d([NaN, Infinity, -Infinity, 0, 1]);
        var r = tf.isNaN(a);
        expect(r.dtype).toEqual('bool');
        test_util_1.expectArraysClose(r, [1, 0, 0, 0, 0]);
    });
    it('gradients: Scalar', function () {
        var a = tf.scalar(NaN);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.isNaN(a); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0]);
    });
    it('gradients: Tensor1D', function () {
        var a = tf.tensor1d([NaN, Infinity, -Infinity, 0, 1]);
        var dy = tf.tensor1d([1, 1, 1, 1, 1]);
        var gradients = tf.grad(function (a) { return tf.isNaN(a); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0, 0, 0, 0, 0]);
    });
    it('gradients: Tensor2D', function () {
        var a = tf.tensor2d([NaN, Infinity, -Infinity, 0], [2, 2]);
        var dy = tf.tensor2d([1, 2, 3, 4], [2, 2]);
        var gradients = tf.grad(function (a) { return tf.isNaN(a); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
    ...
    it('accepts a tensor-like object', function () {
        var r = tf.isNaN([NaN, Infinity, -Infinity, 0, 1]);
        test_util_1.expectArraysClose(r, [1, 0, 0, 0, 0]);
    });
    it('throws for string tensor', function () {
...
jasmine_util_1.describeWithFlags('isInf', jasmine_util_1.ALL_ENVS, function () {
    it('basic', function () {
        ...
        var r = tf.isInf(a);
        expect(r.dtype).toEqual('bool');
        test_util_1.expectArraysClose(r, [0, 1, 1, 0, 0]);
    });
    it('gradients: Scalar', function () {
        var a = tf.scalar(NaN);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.isInf(a); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0]);
    });
    ...
    it('accepts a tensor-like object', function () {
        var r = tf.isInf([NaN, Infinity, -Infinity, 0, 1]);
        test_util_1.expectArraysClose(r, [0, 1, 1, 0, 0]);
    });
    it('throws for string tensor', function () {
...
jasmine_util_1.describeWithFlags('isFinite', jasmine_util_1.ALL_ENVS, function () {
    it('basic', function () {
        ...
        var r = tf.isFinite(a);
        expect(r.dtype).toEqual('bool');
        test_util_1.expectArraysClose(r, [0, 0, 0, 1, 1]);
    });
    it('gradients: Scalar', function () {
        var a = tf.scalar(NaN);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.isFinite(a); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0]);
    });
    ...
    it('accepts a tensor-like object', function () {
        var r = tf.isFinite([NaN, Infinity, -Infinity, 0, 1]);
        test_util_1.expectArraysClose(r, [0, 0, 0, 1, 1]);
    });
    it('throws for string tensor', function () {
...
jasmine_util_1.describeWithFlags('exp', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.exp(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [3 * Math.exp(0.5)]);
    });
...
jasmine_util_1.describeWithFlags('expm1', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.expm1(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [3 * Math.exp(0.5)]);
    });
...
jasmine_util_1.describeWithFlags('sin', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.sin(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 * Math.cos(5)]);
    });
...
jasmine_util_1.describeWithFlags('cos', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.cos(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 * Math.sin(5) * -1]);
    });
...
jasmine_util_1.describeWithFlags('tan', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.tan(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 / (Math.cos(0.5) * Math.cos(0.5))]);
    });
    it('gradients: Tensor1D', function () {
        ...
        test_util_1.expectArraysClose(gradients, expected, test_util_1.TEST_EPSILON_FLOAT16);
    });
    it('gradients: Tensor2D', function () {
        var aValues = [-3, 1, 2, 3];
        var dyValues = [1, 2, 3, 4];
...
jasmine_util_1.describeWithFlags('asin', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.asin(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 / Math.sqrt(1 - (0.5 * 0.5))]);
    });
...
jasmine_util_1.describeWithFlags('acos', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.acos(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [(-1 * 8) / Math.sqrt(1 - (0.5 * 0.5))]);
    });
...
jasmine_util_1.describeWithFlags('atan', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.atan(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 / (1 + (0.5 * 0.5))]);
    });
...
jasmine_util_1.describeWithFlags('sinh', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.sinh(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 * Math.cosh(0.5)]);
    });
...
jasmine_util_1.describeWithFlags('cosh', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.cosh(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 * Math.sinh(0.5)]);
    });
...
jasmine_util_1.describeWithFlags('tanh', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.tanh(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 * (1 - (Math.tanh(0.5) * Math.tanh(0.5)))]);
    });
...
jasmine_util_1.describeWithFlags('leakyRelu', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var dy = tf.scalar(8);
        var alpha = 0.1;
        var gradients = tf.grad(function (a) { return tf.leakyRelu(a.clone(), alpha).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 * alpha]);
    });
...
jasmine_util_1.describeWithFlags('elu', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var x = tf.tensor1d([1, 3, -2]);
        var dy = tf.tensor1d([5, 50, 500]);
        var gradients = tf.grad(function (a) { return tf.elu(a.clone()).clone(); })(x, dy);
        expect(gradients.shape).toEqual(x.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [5, 50, 500 * Math.exp(-2)]);
    });
...
jasmine_util_1.describeWithFlags('selu', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var a = tf.scalar(aValue);
        var dy = tf.scalar(dyValue);
        var gradients = tf.grad(function (a) { return tf.selu(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [dyValue * scale]);
    });
...
jasmine_util_1.describeWithFlags('clip', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        ...
        var x = tf.scalar(-10); // Clipped.
        var dy = tf.scalar(5);
        var gradients = tf.grad(function (x) { return x.clone().clipByValue(min, max).clone(); })(x, dy);
        expect(gradients.shape).toEqual(x.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0]);
    });
    it('derivate with primitive as input', function () {
        var min = -1;
        var max = 2;
        var x = -10;
        var dy = tf.scalar(5);
...
jasmine_util_1.describeWithFlags('round', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(5.2);
        var dy = tf.scalar(3);
        var gradients = tf.grad(function (a) { return tf.round(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [0]);
    });
...
jasmine_util_1.describeWithFlags('asinh', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.asinh(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 / Math.sqrt(1.0 + 0.5 * 0.5)]);
    });
...
jasmine_util_1.describeWithFlags('acosh', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(1.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.acosh(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8.0 / Math.sqrt(1.5 * 1.5 - 1.0)]);
    });
...
jasmine_util_1.describeWithFlags('atanh', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.atanh(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 / (1 - 0.5 * 0.5)]);
    });
...
jasmine_util_1.describeWithFlags('erf', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('gradient with clones', function () {
        var a = tf.scalar(0.5);
        var dy = tf.scalar(8);
        var gradients = tf.grad(function (a) { return tf.erf(a.clone()).clone(); })(a, dy);
        expect(gradients.shape).toEqual(a.shape);
        expect(gradients.dtype).toEqual('float32');
        test_util_1.expectArraysClose(gradients, [8 * 2 * Math.exp(-0.5 * 0.5) / Math.sqrt(Math.PI)]);
    });
