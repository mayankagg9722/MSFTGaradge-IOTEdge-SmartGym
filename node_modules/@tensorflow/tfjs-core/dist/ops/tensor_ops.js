...
function onesLike_(x) {
    ...
    return engine_1.ENGINE.runKernel(function (backend) { return backend.onesLike($x); }, { $x: $x }, null);
}
/**
...
function zerosLike_(x) {
    ...
    return engine_1.ENGINE.runKernel(function (backend) { return backend.zerosLike($x); }, { $x: $x }, null);
}
/**
