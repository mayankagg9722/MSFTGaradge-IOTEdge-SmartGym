...
jasmine_util_1.describeWithFlags('tex_util encodeMatrixToUnpackedArray, channels = 4', backend_webgl_test_registry_1.WEBGL_ENVS, function () {
...
jasmine_util_1.describeWithFlags('tex_util encodeMatrixToUnpackedArray, channels = 1', backend_webgl_test_registry_1.WEBGL_ENVS, function () {
    it('1x1 writes the only matrix array value to the only texel', function () {
        var matrix = new Float32Array([1]);
...
jasmine_util_1.describeWithFlags('tex_util decodeMatrixFromUnpackedArray', backend_webgl_test_registry_1.WEBGL_ENVS, function () {
...
jasmine_util_1.describeWithFlags('tex_util encodeMatrixToPackedRGBA', backend_webgl_test_registry_1.WEBGL_ENVS, function () {
...
jasmine_util_1.describeWithFlags('tex_util decodeMatrixFromPackedRGBA', backend_webgl_test_registry_1.WEBGL_ENVS, function () {
