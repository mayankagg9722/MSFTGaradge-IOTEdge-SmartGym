...
environment_1.ENV.registerFlag('WEBGL_CPU_FORWARD', function () { return false; });
/** Whether to turn all packing related flags on. */
environment_1.ENV.registerFlag('WEBGL_PACK', function () { return environment_1.ENV.getBool('HAS_WEBGL'); });
/** Whether we will pack the batchnormalization op. */
environment_1.ENV.registerFlag('WEBGL_PACK_BATCHNORMALIZATION', function () { return environment_1.ENV.getBool('WEBGL_PACK'); });
