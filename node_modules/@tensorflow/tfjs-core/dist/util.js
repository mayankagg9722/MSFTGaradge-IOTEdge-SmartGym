...
var getSystemFetch = function () {
    if (environment_1.ENV.global.fetch != null) {
        return environment_1.ENV.global.fetch;
    }
    else if (environment_1.ENV.get('IS_NODE')) {
        return exports.getNodeFetch.fetchImport();
    }
    throw new Error("Unable to find the fetch() method. Please add your own fetch() " +
...
function fetch(path, requestInits) {
    if (exports.systemFetch == null) {
        exports.systemFetch = getSystemFetch();
    }
